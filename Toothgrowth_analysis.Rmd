...
However, without a control group or trial, i.e. where no vitamin C supplement is given, these findings cannot be conclusive, as other factors cannot be ruled out, e.g. simply a more nutrious diet may increase tooth growth, rather then a particular vitamin. 
