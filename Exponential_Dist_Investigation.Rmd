...
The variance of the sample mean is ${\sigma}^2/n$, whose estimate is given by ${S}^2/n$. In the simulations above the variance of the sample mean theoretically should be `r varMean`, whereas it was found to be `r sampleMeanVar` 
